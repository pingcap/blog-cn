...
目前这套系统已经被很多用户应用了，大家可以查看[《TiDB HTAP 助力小红书业务升级》](/user-case-xiaohongshu-2/)、[《TiDB 4.0 在 VIPKID 的应用实践》](/user-case-vipkid/)、[《海外直播软件 Bigo 的 TiDB 4.0 线上实践》](/user-case-bigo/)、[《从 Exadata 到 TiDB，中通快递 HTAP 实践》](/user-case-zto-express/)，看看我们的用户现在怎么用以及现在这套他们用的好不好。
