...
+ [RecordSet](https://github.com/pingcap/tidb/blob/rc2.3/ast/ast.go#L136)
...
这个结构实现了 [`ast.RecordSet`](https://github.com/pingcap/tidb/blob/rc2.3/ast/ast.go#L142) 接口，从字面上大家可以看出，这个接口代表了查询结果集的抽象，我们看一下它的几个方法：
