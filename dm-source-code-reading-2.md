...
本文为 DM 源码阅读系列文章的第二篇，[《DM 源码阅读系列文章（一）序》](https://pingcap.com.pingcap.com/blog-cn/dm-source-code-reading-1/) 简单介绍了 DM 源码阅读的目的和规划，以及 DM 的源码结构以及工具链。从本篇文章开始，我们会正式开始阅读 DM 的源码。
