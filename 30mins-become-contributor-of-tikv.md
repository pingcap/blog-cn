...
在TiKV 同级目录的 `scalar_function.rs` 文件里，找到 ScalarFunc 的 `check_args` 函数，按照现有的模式，加入参数个数的检查即可。
...
完成以上几个步骤之后，就可以给 TiKV 项目提 PR 啦。 想要了解提 PR 的基础知识，尝试移步[此文]([https://pingcap.com/blog-how-to-contribute-zh](https://pingcap.com/blog-how-to-contribute-zh))，看看是否有帮助。
