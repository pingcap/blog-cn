...
![图 2  What is TiFlash](media/tidb-with-tiflash-extension/1.png)
...
![图 3 TiFlash Architecture](media/tidb-with-tiflash-extension/1.png)
...
![图 4 Row Based vs Column Based](media/tidb-with-tiflash-extension/1.png)
...
![图 5 Raft Learner Replication](media/tidb-with-tiflash-extension/1.png)
...
![图 6 Learner Read (1/2)](media/tidb-with-tiflash-extension/1.png)

<center>图 6 Learner Read (1/2)</center>

![图 7 Learner Read (2/2)](media/tidb-with-tiflash-extension/1.png)
...
![图 8 Update Support](media/tidb-with-tiflash-extension/1.png)
...
![图 9  AP 与 TP 业务隔离](media/tidb-with-tiflash-extension/1.png)
...
![图 10 Combination of TiFlash and TiKV](media/tidb-with-tiflash-extension/1.png)
...
![图 11 SQL MPP Push Down](media/tidb-with-tiflash-extension/1.png)
...
![图 12  性能数据](media/tidb-with-tiflash-extension/1.png)
...
![图 13 TiDB Data Platform](media/tidb-with-tiflash-extension/1.png)
