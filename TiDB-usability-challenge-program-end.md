...
​恭喜各位获奖的同学，是你们让 TiDB 更加易用​。在参赛选手的不断努力下，TiDB 4.0 得到了极大的优化，在即将举办的 TiDB DevCon 2020 上将会发布 TiDB 4.0 GA，我们将可以一起见证更加易用、更加稳定的 TiDB​。
至此 TiDB 挑战赛第二季之易用性挑战赛和 TiDB 4.0 捉“虫”竞赛同时告一段落，当然后续还将举办各类有趣的竞赛，可以保持关注​！​